...
const createSchema = z
  .object({
    ...
    new_customer: z
      ...
      .nullable(),
    // The number is printed by Gerry's external card system; we only record it.
    card_no: z.string().trim().min(1, "Card number is required").max(64),
...
/** Record a card — for an existing customer, or create the customer inline. */
