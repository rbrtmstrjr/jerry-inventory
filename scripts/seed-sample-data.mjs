 ...
 * fishing supply dealer). MASTER STOCK ONLY — nothing is delivered to shops.
...
const P = (pesos) => Math.round(pesos * 100); // pesos → centavos

// ---------------------------------------------------------------------------
// Catalog: [name, category, unit, cost₱, price₱, reorder, qty, barcode|null, supplierKey]
// supplierKey: yamaha = genuine parts dist · hardware = oils/consumables · fishing = gear
// ---------------------------------------------------------------------------
const PARTS = [
  // ---- Engine Parts (genuine / branded) ----
  ["Impeller — Yamaha 40HP (E40G)",              "Engine Parts", "pc",   380,  580,  5,  10, "4997323117402", "yamaha"],
  ["Impeller — Yamaha 15HP (E15D)",              "Engine Parts", "pc",   320,  500,  5,  10, "4997323115156", "yamaha"],
  ...
  ["CDI Unit — Yamaha E40G",                     "Engine Parts", "pc",  2600, 3900,  2,   3, null,            "yamaha"],
  ["Carburetor Repair Kit — Yamaha 40HP",        "Engine Parts", "set",  450,  720,  4,   8, null,            "yamaha"],
  ["Fuel Pump Assy — Yamaha E40",                "Engine Parts", "pc",   850, 1350,  3,   5, null,            "yamaha"],
  ["Propeller 3-Blade — Yamaha 40HP 11-1/8×13G", "Engine Parts", "pc",  2900, 4300,  3,   4, null,            "yamaha"],
  ["Propeller 3-Blade — Yamaha 15HP 9-1/4×9J",   "Engine Parts", "pc",  2200, 3300,  3,   4, null,            "yamaha"],
  ["Zinc Anode — Yamaha 40HP",                   "Engine Parts", "pc",   180,  300,  8,  15, null,            "yamaha"],
  ...
  ["Head Gasket — Yamaha E40",                   "Engine Parts", "pc",   380,  600,  4,   8, null,            "yamaha"],
  ["Piston Ring Set STD — Yamaha E40",           "Engine Parts", "set",  520,  820,  4,   6, null,            "yamaha"],
  ["Recoil Starter Spring — E15/E40",            "Engine Parts", "pc",   240,  400,  4,   6, null,            "yamaha"],
  ["Water Pump Repair Kit — Tohatsu M18",        "Engine Parts", "set",  680, 1050,  3,   5, null,            "yamaha"],
  ["Throttle Cable — Universal 40HP",            "Engine Parts", "pc",   260,  420,  5,   8, null,            "hardware"],
  ...
  ["Gear Oil SAE 90 — 250ml",                    "Oil & Lubricants", "bottle", 140, 220, 12, 24, null,            "hardware"],
  ...
  ["Kerosene Pressure Lamp — Butterfly #950",    "Fisherman Gear", "pc",   1850, 2650,  2,   4, null, "fishing"],
  ...
  ["Hose Clamp SS 1/2\"–3/4\"",                  "Consumables", "pc",    25,  50, 30,  60, null, "hardware"],
  ["Cotton Rags (per kg)",                       "Consumables", "kg",    60, 110, 10,  20, null, "hardware"],
];

// Items Jerry repacks himself — get internal JM barcodes
const REPACKED = [
...
const SUPPLIERS = {
  yamaha:   { name: "Cebu Marine Equipment Corp.",     contact: "Vito Ramos — 0917 555 2210",  notes: "Yamaha/Tohatsu distributor — engines & genuine parts" },
  hardware: { name: "Mandaue Oil & Hardware Trading",  contact: "(032) 345-6789",              notes: "Oils, lubricants, consumables" },
  fishing:  { name: "JLT Fishing Supply",              contact: "Jenny Tan — 0918 555 0834",   notes: "Nets, lines, ropes, fisherman goods" },
};

// ---------------------------------------------------------------------------
console.log("Cleaning up old RCV-TEST leftovers…");
{
...
console.log("Receivings into MASTER…");
...
const receivings = [
  { key: "yamaha",   note: "Initial stocking — engines & genuine parts", engines: newEngines },
  { key: "hardware", note: "Initial stocking — oils & consumables",      engines: [] },
  { key: "fishing",  note: "Initial stocking — fisherman gear",          engines: [] },
];
...
console.log("Internal barcodes for repacked items…");
...
console.log("\nDone — everything is in MASTER stock only. Deliver to branches from the Deliveries screen.");
